...
const Search = () => {
	...
	const [articlesIndex, setArticlesIndex] =
		React.useState<FuseIndex<searchResult>>();
	...
	return (
		<div className="container mx-auto">
			...
			<main className="max-w-6xl mx-auto">
				...
				<div className="px-2">
					<h1 className="mb-2 grow text-xl font-bold my-5">
						Resultados de la búsqueda
					</h1>
					<div className="mx-auto">
						{!query.q && <div>Por favor escribe el texto a buscar</div>}
						{query.q && searchResults.length === 0 && (
							<div>No se encontró ningún resultado para esa búsqueda.</div>
						)}
					...
					<Link
						href={"/posts/page/1"}
						className="block justify-center text-right py-5 font-bold text-sm text-red-700"
					>
